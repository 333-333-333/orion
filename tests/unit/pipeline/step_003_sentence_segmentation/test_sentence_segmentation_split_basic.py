...
def test_sentence_segmentation_keeps_am_pm_abbreviations_together():
    from pipeline.step_003_sentence_segmentation import segment_sentences

    payload = {
        "raw_text": "Breakfast starts at 8 a.m. on Monday. Dinner starts at 6 p.m. Bring ID.",
        "preprocessed_text": "Breakfast starts at 8 a.m. on Monday. Dinner starts at 6 p.m. Bring ID.",
        "source_text_id": "src-sent-time-001",
    ...
    assert [s["text"] for s in result["sentences"]] == [
        "Breakfast starts at 8 a.m. on Monday.",
