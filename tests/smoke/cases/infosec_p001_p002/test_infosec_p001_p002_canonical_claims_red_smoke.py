...
_EXPECTED_STATEMENTS_BY_PARAGRAPH: dict[str, set[str]] = {
    "p001": {
        ...
        "InformationSecurity is focused on protecting InformationAsset against InternalThreat",
        "InformationSecurity is focused on protecting InformationAsset against ExternalThreat",
        "InformationAsset is a Resource",
        "InformationAsset has value for Organization",
        "InformationAsset may store Information as one alternative",
        "InformationAsset may process Information as one alternative",
        "InformationAsset may transmit Information as one alternative",
        "InformationAsset may represent Information as one alternative",
    ...
    "p002": {
        "InformationSecurity has purpose to preserve Confidentiality",
        "InformationSecurity has purpose to preserve Integrity",
        "InformationSecurity has purpose to preserve Availability",
        ...
        "CIATriad has member Confidentiality",
        "CIATriad has member Integrity",
        "CIATriad has member Availability",
